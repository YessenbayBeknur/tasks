...
function Name($list){
  ?> <div class = "card">
    <img src="<?php echo $list["image"] ?>" style="height: 60px;width: 90px;">
      <div class="description">
        <div class = "title"> <?php echo $list["maker"];echo " ";echo $list["model"]; ?> </div>
        <div class = "price"> <?php echo $list["price"] ?> </div>
        <div class = "year"> <?php echo $list["year"] ?> </div>
      </div>
    </div>
    <?php
}
